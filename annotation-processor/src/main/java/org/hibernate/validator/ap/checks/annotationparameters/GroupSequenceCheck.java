...
public class GroupSequenceCheck extends AnnotationParametersAbstractCheck {
	...
	protected Set<ConstraintCheckIssue> doCheck(Element element, AnnotationMirror annotation) {
		...
		ConstraintCheckIssue cyclicDefinitionIssue = checkForCyclicDefinition( CollectionHelper.<TypeMirror>newLinkedHashSet(), annotatedElement.asType(), annotatedElement, annotation );
